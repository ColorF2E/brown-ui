...
export default {
    ...
    computed: {
        ...
        leftLabel() {
            return (
                ...
                " " +
                this.$t(`el.datepicker.month${this.date.getMonth() + 1}`)
            );
        },
        rightLabel() {
            return (
    ...
    watch: {
        showTime(val) {
            ...
            this.$nextTick(_ => {
                ...
                if (minInputElm) {
                    this.minPickerWidth =
                        minInputElm.getBoundingClientRect().width + 10;
                }
                if (maxInputElm) {
                    this.maxPickerWidth =
                        maxInputElm.getBoundingClientRect().width + 10;
                }
            });
        },
        minDate() {
    ...
    methods: {
        ...
        handleDateInput(event, type) {
            ...
            if (parsedValue) {
                ...
                const target = new Date(
                    type === "min" ? this.minDate : this.maxDate
                );
                if (target) {
        ...
        handleRangePick(val, close = true) {
            ...
            // console.log("val.maxDate: ", val.maxDate);
