    ...
    <div class="tree-node" v-show="!node.parentNode || node.parentNode._expanded">
        <div
            ...
            <span class="node-triangle"
                ...
                <i class="brown-icon icon-triangle-right"
                    :class="{'rotate-90': node._expanded}">
                </i>
            </span>
            <span
                v-if="TreeModel._multiple"
                class="node-checkbox brown-icon"
                :class="{
...
<script>
    ...
    export default {
        name: 'ElSelectTreeNode',
        componentName: 'ElSelectTreeNode',
        ...
        methods: {
            ...
            toggle() {
                this.node._checked ? this.uncheck() : this.check();
            }
        }
    }
</script>
