    ...
    <div class="el-select"
        ...
        <div class="el-select-tags"
            ...
            <transition-group @after-leave="resetInputHeight">
                <el-tag v-for="item in selected"
                        ...
                        close-transition>
                    <span class="el-select-tags-text">{{ item.currentLabel }}</span>
                </el-tag>
            </transition-group>
        ...
        <transition name="el-zoom-in-top"
            ...
            <el-select-menu ref="popper"
                ...
                <el-scrollbar
                        tag="ul"
                        wrap-class="el-select-dropdown-wrap"
                ...
                <p class="el-select-dropdown-empty"
        ...
        methods: {
            ...
            scrollToOption(option) {
                ...
                if (this.$refs.popper && target) {
                    const menu = this.$refs.popper.$el.querySelector('.el-select-dropdown-wrap');
